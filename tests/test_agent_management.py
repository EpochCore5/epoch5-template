...
class TestAgentManager:
    ...
    def test_log_heartbeat(self, agent_manager):
        ...
        # The implementation might not use a heartbeat file
        # or might not return anything
    ...
    def test_nonexistent_agent(self, agent_manager):
        ...
        result = agent_manager.update_agent_stats(fake_did, False, 1.0)  # success=False, latency=1.0
        assert result is False
