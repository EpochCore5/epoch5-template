...
class TestCapsuleManager:
    ...
    def test_list_capsules(self, capsule_manager):
        ...
        # The list_capsules method returns the values from the index,
        # which doesn't include capsule_id in each item
        assert all(isinstance(capsule, dict) for capsule in capsules)
