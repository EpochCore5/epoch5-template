...
class TestCapsuleManager:
    ...
    def test_store_capsule(self, capsule_manager):
        ...
        # Verify capsule is indexed - use the capsules_index file
    ...
    def test_list_capsules(self, capsule_manager):
        ...
        # The list_capsules() returns index values, which contain these fields
    ...
    def test_nonexistent_capsule(self, capsule_manager):
        ...
        # For nonexistent capsule, it returns {"error": "Capsule not found"}
